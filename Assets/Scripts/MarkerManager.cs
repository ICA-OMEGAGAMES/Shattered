...
public abstract class MarkerManager : MonoBehaviour{

    List<GameObject> markers = new List<GameObject>();
    protected List<GameObject> hitBySwing = new List<GameObject>();
    ...
    public abstract void NotifyHit(GameObject hitTarget, float damage);
}
