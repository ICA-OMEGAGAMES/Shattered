...
public class TestDialogueUIBehaviour : Yarn.Unity.Shattered.DialogueUIBehaviour {
...
public class YarnSpinnerTests {
    ...
    Yarn.Unity.Shattered.DialogueRunner dialogueRunner;
    Yarn.Unity.Shattered.VariableStorageBehaviour variableStorage;
    ...
    public void SetUp()
    {
        ...
        dialogueRunner = dialogueHost.AddComponent<Yarn.Unity.Shattered.DialogueRunner>();
